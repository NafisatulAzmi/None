# -*- coding: utf-8
# Coded By Pelaut Kode
# https://facebook.com/pelautkode
# instagram.com/paan_finest
# Jangan di edit please 
...
def logo():
    print ("""
                ____     ______
   ____ ___    / __ )   / ____/ Created : Senin, 14 Juni 2021
  / __ `__ \  / __  |  / /_    
 / / / / / / / /_/ /  / __/    
/_/ /_/ /_/ /_____/  /_/       
[ \033[0;91mSimple Multi Brute Force ]
\033[1;92m Github : https://github.com/Pelautkode
      """)
...
def login():
	...
	try:
		...
		logo()
		print("\n \033[0;97m[\033[0;93m*\033[0;97m] Pilih Metode Login Facebook :")
		print(" \033[0;97m[\033[0;96m1\033[0;97m] Login Dengan Token")
		print(" \033[0;97m[\033[0;96m2\033[0;97m] Login Dengan Cookie")
